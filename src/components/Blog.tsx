...
const ARTICLES = [
  {
    ...
    excerpt: "How I pivoted from a B.E degree to Full Stack Development. The challenges, the late nights, and the breakthroughs.",
    category: "Journey",
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt: "A deep dive into how I built the InSource IT Solutions backend using Java, SpringBoot, Docker, and RabbitMQ for asynchronous communication.",
    category: "Tech",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt: "Explaining why I chose Java and Spring Boot for The Hashed, focusing on scalability, security, microservices architecture, and long-term performance for building a reliable e-commerce platform.",
    category: "Tech",
    readTime: "6 min read",
