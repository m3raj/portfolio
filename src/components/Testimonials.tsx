...
const TESTIMONIALS = [
  {
    quote: "Meraj delivered exceptional code on the InSource IT Solutions project. His understanding of microservices is top-notch.",
    name: "Alex Morgan",
    role: "Project Manager, InSource IT Solutions",
    initials: "AM",
  },
  {
    quote: "The Hashed platform is blazing fast. Meraj's optimization skills significantly improved our conversion rates.",
    name: "Vaibhav Patel",
    role: "CTO, The Hashed",
    initials: "VP",
  },
