...
const skills = [
  { category: "Frontend", items: ["Angular.js", "React", "TypeScript", "CSS", "JSP", "HTML"] },
  { category: "Backend", items: ["Java", "SprigBoot", "Microservices", "PostgreSQL", "MongoDB", "RabbitMQ"] },
  { category: "DevOps & Cloud", items: ["Docker", "Kubernetes", "AWS", "GCP", "CI/CD", "Nginx"] },
];
